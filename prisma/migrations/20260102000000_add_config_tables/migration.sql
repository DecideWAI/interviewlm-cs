...
-- AssessmentTemplateConfig table (drop and recreate to fix schema)
...
CREATE INDEX IF NOT EXISTS "assessment_template_configs_role_seniority_idx" ON "assessment_template_configs"("role", "seniority");
